        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/buy-car" className="text-gray-400 hover:text-cyan-400 text-sm transition-colors">
                  Buy Car
                </Link>
              </li>
              <li>
                <Link href="/sell-car" className="text-gray-400 hover:text-cyan-400 text-sm transition-colors">
                  Sell Car
                </Link>
              </li>
              <li>
                <Link href="/my-garage" className="text-gray-400 hover:text-cyan-400 text-sm transition-colors">
                  My Garage
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {currentYear} DriveSphere. All rights reserved.
            </p>
